...
{
    // 用户凭据持久化 — SHA256(salt + password) hex 存到 EXE 同目录 register_credentials.json
    ...
    internal static class CredentialStore
    {
        ...
        private static string FilePath {
            get { return Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "register_credentials.json"); }
        }
        ...
        private static string RememberPath {
            get { return Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "register_remember.json"); }
        }
